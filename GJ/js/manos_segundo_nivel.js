...
var manos_segundo_nivel = {
  preload: function()
  {
    game.scale.scaleMode = Phaser.ScaleManager.SHOW_ALL;
  	...
  	game.load.image('imagen0','img/dientes/5.png');
  	game.load.image('imagen1','img/dientes/6.png');
  	game.load.image('imagen2','img/dientes/7.png');
  	game.load.image('imagen3','img/dientes/8.png');
  ...
  cambiarVista: function()
  {
    ...
    game.state.add('manos_segundo_nivel_juego', manos_segundo_nivel_juego);
    game.state.start('manos_segundo_nivel_juego');
  },
