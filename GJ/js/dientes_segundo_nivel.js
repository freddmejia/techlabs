...
var dientes_segundo_nivel = {
  preload: function()
  {
    game.scale.scaleMode = Phaser.ScaleManager.SHOW_ALL;
  	...
  	game.load.image('imagen0','img/manos/5.png');
  	game.load.image('imagen1','img/manos/6.png');
  	game.load.image('imagen2','img/manos/7.png');
  	game.load.image('imagen3','img/manos/8.png');
  ...
  cambiarVista: function()
  {
    ...
    game.state.add('dientes_segundo_nivel_juego', dientes_segundo_nivel_juego);
    game.state.start('dientes_segundo_nivel_juego');
  },
